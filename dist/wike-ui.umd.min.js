(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rem = factory(global._vue));
}(this, (function (_vue) { 'use strict';

  var WIcon = _vue.defineComponent({
      name: "WIcon",
      props: {
          name: {
              type: String,
  ...
  */
  ...
  function renderjsx(preview, fullscreen, scrolling, action) {
      ...
      return !preview ? "" : _vue.createVNode("ul", {
          "class": "markdown-toolbars"
      }, [_vue.createVNode("li", {
              "class": "tools_title"
          }, [_vue.createTextVNode("WK\u7F16\u8F91\u5668")]), renderList(data), renderTitle(title), renderList(other), renderScrolling(scrolling), renderDownload(), _vue.createVNode("li", {
              "class": "empty"
          }, null), renderFullscreen(fullscreen)]);
  }
  function renderList(data) {
      return data.map(function (item) {
          return _vue.createVNode("li", {
              "name": item.tip
          }, [_vue.createVNode(WIcon, {
                  "name": item.name,
                  "onClick": item.action,
                  "class": "iconfont"
              }, null, 8
  ...
  function renderScrolling(scrolling) {
      ...
      }, [scrolling ? _vue.createVNode(WIcon, {
              "name": "fa-toggle-on",
              "class": "iconfont"
          }, null) : _vue.createVNode(WIcon, {
              "name": "fa-toggle-off",
              "class": "iconfont"
          }, null)], 8
      /* PROPS */
  ...
  function renderFullscreen(fullscreen) {
      return fullscreen ? _vue.createVNode("li", {
          "name": "退出全屏"
      }, [_vue.createVNode(WIcon, {
              "name": "fa-window-close-o",
              "class": "iconfont"
          }, null)]) : _vue.createVNode("li", {
          "name": "全屏"
      }, [_vue.createVNode(WIcon, {
              "name": "fa-arrows-alt",
              "class": "iconfont"
  ...
  function renderDownload() {
      return _vue.createVNode("li", {
          "class": "download"
              ...
              "name": "fa-download",
              "class": "iconfont"
          }, null), _vue.createVNode("ul", {
              "class": "hover_show"
          }, [_vue.createVNode("li", null, [_vue.createVNode(WIcon, {
                      "name": "fa-file-o",
                      "class": "iconfont",
                      "style": "display:inline;margin-right:10px"
                  }, null), _vue.createTextVNode("\u5BFC\u51FA Markdown")]), _vue.createVNode("li", null, [_vue.createVNode(WIcon, {
                      "name": "fa-file-pdf-o",
                      "class": "iconfont",
                      "style": "display:inline;margin-right:10px"
                  }, null), _vue.createTextVNode("\u5BFC\u51FA pdf")])])]);
  }
  ...
  var WTools = _vue.defineComponent({
      name: "WTools",
      ...
      setup: function setup(props, contxext) {
          var lastInsert = _vue.ref("");
          _vue.onMounted(function () { });
          console.log();
          return function () {
              // @ts-ignore
              return _vue.createVNode("nav", {
                  "class": "nav-markdown-toolbars"
              }, [_vue.createTextVNode(" "), renderjsx(props.preview, props.fullscreen, props.scrolling, createAcitons(props.editor, props.lastPos, lastInsert, contxext.emit))]);
          };
      }
  });
  /*
  *
  ...
  var WMd = _vue.defineComponent({
      ...
      setup: function setup(props, ctx) {
          //数据
          var preview = _vue.ref(true);
          var split = _vue.ref(true);
          var codemirrorview = _vue.ref(null);
          var previewview = _vue.ref(null);
          var previewInner = _vue.ref(null);
          var markdown = _vue.ref(null);
          var htmldata = _vue.ref("");
          var fullscreen = _vue.ref(false);
          var editor = _vue.ref(null);
          var value = _vue.ref(props.value);
          var editorScrollHeight = _vue.ref(0);
          var lastPos = _vue.ref("");
          var timeoutId = _vue.ref(null);
          var indexLenth = _vue.ref(1);
          var scrollSide = _vue.ref("");
          var scrolling = _vue.ref(true);
          var instance = _vue.ref(null);
          var timeid = null;
          var eventConfig = {
          ...
          var showView = _vue.computed(function () {
          ...
          var renderEdior = function renderEdior() {
              return _vue.createVNode("div", {
                  ...
                  /* PROPS */
                  , ["onUploadImage", "onSetCursor", "onHello", "fullscreen", "split", "scrolling", "preview", "editor", "lastPos", "value", "exportFileName"]), _vue.createVNode("div", {
                      "class": "markdown-content",
                      "style": {
                          background: preview.value ? "fff" : ""
                      }
                  }, [!preview.value ? "" : _vue.createVNode("div", {
                          "class": "codemirror",
                          "ref": codemirrorview,
                      ...
                      , ["onMouseenter"]), !showView ? "" : _vue.createVNode("div", {
          ...
          _vue.watch(props.value, function (value) {
              value.value = value;
              editor.value.setOption("value", value);
          });
          _vue.watch(htmldata, function () {
          ...
          _vue.onUnmounted(function () {
              clearInterval(timeid);
          });
          return function () {
              return _vue.createVNode("div", null, [!props.isPreview ? renderEdior() : renderPreview()]);
          };
      }
  });
  /*
