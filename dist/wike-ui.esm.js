import { defineComponent, createVNode, createTextVNode, ref, onMounted, computed, watch, onUnmounted, nextTick } from 'vue';

var WIcon = defineComponent({
    name: "WIcon",
    props: {
        name: {
            type: String,
...
Object.keys(languages$1).forEach(function (key) {
  hljs.registerLanguage(key, languages$1[key]);
});
...
var renderer = new index.Renderer();
var marked = index.setOptions({
  renderer: renderer,
  gfm: true,
  tables: true,
  breaks: false,
...
function renderjsx(preview, fullscreen, scrolling, action) {
    var data = [{
            "tip": "撤销",
            "name": "fa-undo",
            "action": action.undo
    ...
    return !preview ? "" : createVNode("ul", {
        "class": "markdown-toolbars"
    }, [createVNode("li", {
            "class": "tools_title"
        }, [createTextVNode("WK\u7F16\u8F91\u5668")]), renderList(data), renderTitle(title), renderList(other), renderScrolling(scrolling), renderDownload(), createVNode("li", {
            "class": "empty"
        }, null), renderFullscreen(fullscreen)]);
}
...
function renderScrolling(scrolling) {
    ...
    }, [scrolling ? createVNode(WIcon, {
            "name": "fa-toggle-on",
            "class": "iconfont"
        }, null) : createVNode(WIcon, {
            "name": "fa-toggle-off",
            "class": "iconfont"
        }, null)], 8
    /* PROPS */
...
function renderFullscreen(fullscreen) {
    return fullscreen ? createVNode("li", {
        "name": "退出全屏"
    }, [createVNode(WIcon, {
...
function renderDownload() {
    return createVNode("li", {
        "class": "download"
            ...
            "class": "hover_show"
        }, [createVNode("li", null, [createVNode(WIcon, {
                    "name": "fa-file-o",
                    "class": "iconfont",
                    "style": "display:inline;margin-right:10px"
                }, null), createTextVNode("\u5BFC\u51FA Markdown")]), createVNode("li", null, [createVNode(WIcon, {
                    "name": "fa-file-pdf-o",
                    "class": "iconfont",
                    "style": "display:inline;margin-right:10px"
                }, null), createTextVNode("\u5BFC\u51FA pdf")])])]);
}
...
function createAcitons(editor, lastPos, lastInsert, emit) {
    var redo = function redo() {
        emit("hello", 1111);
        editor === null || editor === void 0 ? void 0 : editor.value.redo(); //重做编辑器
    };
    var undo = function undo() {
        editor === null || editor === void 0 ? void 0 : editor.value.undo();
    };
    var insertContent = function insertContent(str) {
        editor === null || editor === void 0 ? void 0 : editor.value.replaceSelection(str);
        lastInsert.value = str.replace(/\n/g, ''); //保存上一次插入的内容，去掉空格 这个功能用于 列表等操作按回车自增
    };
    var insertStrong = function insertStrong() {
        // 粗体
        var _lastPos$line = lastPos.line, line = _lastPos$line === void 0 ? 0 : _lastPos$line, _lastPos$ch = lastPos.ch, ch = _lastPos$ch === void 0 ? 0 : _lastPos$ch;
        var selection = editor === null || editor === void 0 ? void 0 : editor.value.getSelection(); //得到选中的值
        if (selection) {
            //如果有选中值则将选中值替换成 **' + 选中值 + '**'
    ...
    actions = {
        redo: redo,
        undo: undo,
        insertStrong: insertStrong
    };
    return actions;
}

var WTools = defineComponent({
    name: "WTools",
    props: ["editor", "preview", "scrolling", "fullscreen", "split", "lastPos", "currentValue", "exportFileName", "setCursor"],
    setup: function setup(props, contxext) {
        var lastInsert = ref("");
        onMounted(function () { });
        console.log();
        return function () {
            ...
            return createVNode("nav", {
                "class": "nav-markdown-toolbars"
            }, [createTextVNode(" "), renderjsx(props.preview, props.fullscreen, props.scrolling, createAcitons(props.editor, props.lastPos, lastInsert, contxext.emit))]);
        };
    }
});
/*
*
    ...
    />
      ...
      <li name="导入word" class="import-file" v-show="tools.importword">
        ...
        <svg t="1595396885182" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5412" width="15" height="15"><path d="M662.554 0H238.72C163.584 0 102.4 62.003 102.4 138.214v747.597c0 76.186 61.158 138.189 136.32 138.189h537.472c75.162 0 136.32-62.003 136.32-138.189V283.187L662.528 0z m20.096 260.403v-127.13l112.23 127.13H682.65zM154.778 117.504c0.058-37.339 30.319-67.593 67.657-67.635h394.756v272.896h244.403v578.227c-0.058 37.348-30.334 67.606-67.684 67.635H222.438c-37.351-0.029-67.628-30.287-67.686-67.63V117.503zM332.8 512h358.4c14.138 0 25.6-11.462 25.6-25.6s-11.462-25.6-25.6-25.6H332.8c-14.138 0-25.6 11.462-25.6 25.6s11.462 25.6 25.6 25.6z m0 128h358.4c14.138 0 25.6-11.462 25.6-25.6s-11.462-25.6-25.6-25.6H332.8c-14.138 0-25.6 11.462-25.6 25.6s11.462 25.6 25.6 25.6z m0 128h358.4c14.138 0 25.6-11.462 25.6-25.6s-11.462-25.6-25.6-25.6H332.8c-14.138 0-25.6 11.462-25.6 25.6s11.462 25.6 25.6 25.6z" p-id="5413"></path></svg>
      </span>
      <input
        type="file"
...
var WMd = defineComponent({
    ...
    setup: function setup(props, ctx) {
        ...
        var split = ref(true);
        var codemirrorview = ref(null);
        var previewview = ref(null);
        var previewInner = ref(null);
        var markdown = ref(null);
        var htmldata = ref("");
        var fullscreen = ref(false);
        var editor = ref(null);
        var value = ref(props.value);
        var editorScrollHeight = ref(0);
        var lastPos = ref("");
        var timeoutId = ref(null);
        var indexLenth = ref(1);
        var scrollSide = ref("");
        ...
        var mousescrollSide = function mousescrollSide(side) {
            scrollSide.value = side;
        };
        var previewScroll = function previewScroll() {
            if (scrolling.value && scrollSide.value === 'right') {
                var _preview = previewview.value;
                if (!_preview) {
                    return;
                }
                var contentHeight = _preview.offsetHeight;
                var previewScrollHeight = _preview.scrollHeight;
                var previewScrollTop = _preview.scrollTop;
                var scrollTop = parseInt(previewScrollTop * (editorScrollHeigh.value - contentHeight) / (previewScrollHeight - contentHeight), 0);
                editor.value.scrollTo(0, scrollTop);
            }
        }; //计算属性
        var showView = computed(function () {
            return preview.value ? preview.value : split.value;
        });
        var hello = function hello() {
            console.log(11111111111);
        }; //render
        var renderEdior = function renderEdior() {
            return createVNode("div", {
                "class": "markdown " + (fullscreen.value ? "fullscreen" : "") + " " + (props.bordered ? "border" : ""),
                "ref": markdown,
                "style": {
                ...
                /* PROPS */
                , ["onUploadImage", "onSetCursor", "onHello", "fullscreen", "split", "scrolling", "preview", "editor", "lastPos", "value", "exportFileName"]), createVNode("div", {
                    "class": "markdown-content",
                    "style": {
                        background: preview.value ? "fff" : ""
                    }
                }, [!preview.value ? "" : createVNode("div", {
                        "class": "codemirror",
                        "ref": codemirrorview,
                        "onMouseenter": function onMouseenter() {
                            return mousescrollSide("left");
                        }
                    }, null, 40
                    /* PROPS, HYDRATE_EVENTS */
                    , ["onMouseenter"]), !showView ? "" : createVNode("div", {
        ...
        watch(value, function () {
            ...
            timeoutId.value = setTimeout(function () {
                var html = marked(value.value, _extends_1({
                    sanitize: false
                }, props.markedOptions)).replace(/href="/gi, 'target="_blank" href="');
                htmldata.value = html;
                ctx.emit('input', value.value);
            }, 30);
        });
        watch(props.value, function (value) {
            value.value = value;
            editor.value.setOption("value", value);
        });
        watch(htmldata, function () {
        ...
        var markdownScroll = function markdownScroll(data) {
            if (data === void 0) {
                data = {};
            }
            //编辑器区域滚动
            if (scrolling.value && scrollSide.value === "left") {
                var _data = data, _data$doc = _data.doc, height = _data$doc.height, scrollTop = _data$doc.scrollTop;
                var _preview2 = previewview.value;
                var contentHeight = _preview2.offsetHeight;
                var previewScrollHeight = _preview2.scrollHeight;
                if (_preview2) {
                    _preview2.scrollTop = parseInt(scrollTop * (previewScrollHeight - contentHeight) / (height - contentHeight), 0);
                }
            }
        };
        var upload_image = function upload_image(data) {
            //让事件冒泡给
            ctx.emit(eventConfig.imageUpload, data);
        };
        var handleSave = function handleSave() {
            var vmeditor = editor.value;
            if (!vmeditor) {
                return;
            }
        ...
        var handlePaste = function handlePaste(_, e) {
            var _e$clipboardData = e.clipboardData, clipboardData = _e$clipboardData === void 0 ? {} : _e$clipboardData;
            var _clipboardData$types = clipboardData.types, types = _clipboardData$types === void 0 ? [] : _clipboardData$types, items = clipboardData.items;
            var item = null;
        ...
        var listerenKeyupEnter = function listerenKeyupEnter(e) {
            console.log(instance.value.props);
            if (!instance.value) {
                return;
            }
            var lastInsert = instance.value.lastInsert;
            console.log(lastInsert);
            if (lastInsert) {
                //通过对比lastInsert的值 是否属于list内 然后处理 或者数字递增
                var list = ['-', '- [ ]', '- [x]'];
        ...
        var listerenDelete = function listerenDelete() {
            nextTick(function () {
                //删除lastInsert的值
                var vmeditor = editor.value;
                if (!vmeditor) {
        ...
        var addEditorLintener = function addEditorLintener() {
            var vmeditor = editor.value;
            if (!vmeditor) {
                return;
            }
            vmeditor.setSize("auto", props.height);
            vmeditor.on("change", function (data) {
            ...
            vmeditor.on("keydown", function (data, e) {
                if (e.keyCode === 83) {
                    ...
                    listerenDelete(); //删除事件  删除字符
                }
            });
            vmeditor.on("focus", function () {
                try {
        ...
        var createEditor = function createEditor() {
            editor.value = new codemirror(codemirrorview.value, _extends_1({
                value: value.value,
                onload: function onload(data) {
                    var _data$doc$height = data.doc.height, height = _data$doc$height === void 0 ? 0 : _data$doc$height;
        ...
        var init = function init() {
            ...
            setTimeout(function () {
                if (props.autoSave) {
                    //如果配置了autoSave则定时保存
                    timeid = (readOnlyError("timeid"), setInterval(function () {
                        handleSave();
                    }, props.interval));
                }
            }, 20);
        };
        var setCursor = function setCursor(line, ch) {
            if (line === void 0) {
                line = 0;
            }
            if (ch === void 0) {
        ...
        return function () {
            return createVNode("div", null, [!props.isPreview ? renderEdior() : renderPreview()]);
        };
    }
});
/*
...
WMd.install = function (app) {
    app.component(WMd.name, WMd);
};

var components = [WIcon, WMd];
